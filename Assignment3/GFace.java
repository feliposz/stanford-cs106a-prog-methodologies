...
public class GFace extends GCompound {
	...
	public GFace(double width, double height) {
		...
		add(mouth, 0.50 * width - mouth.getWidth() / 2,
				   0.75 * height - mouth.getHeight() / 2);
		add(leftEye, 0.25 * width - leftEye.getWidth() / 2,
					 0.25 *	height - leftEye.getHeight()/2);
		add(rightEye, 0.75 * width - rightEye.getWidth() / 2,
				 	  0.25 * height - rightEye.getHeight()/2);
	}
