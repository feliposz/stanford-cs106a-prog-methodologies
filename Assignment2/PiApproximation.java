...
public class PiApproximation extends ConsoleProgram {
	...
	/* Number of "darts" to throw in the circle */
	private static final int NDARTS = 10000;
	
	public void run() {
		RandomGenerator rgen = RandomGenerator.getInstance();
		
		int hits = 0; /* darts that hit inside of the circle */
		...
		/*
	      ...
	      */
		double pi = (4.0 * hits) / NDARTS;		
		println("The approximation of PI calculated is " + pi); 
